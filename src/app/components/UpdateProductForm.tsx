...
import { createAProduct, updateProductById } from '@/api/backend/Products.ts';
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Rename your Product</FormLabel>
              <FormControl>
                <Input placeholder="New product name here..." {...field} />
              </FormControl>
              <FormDescription>
                This is what your Product shall be renamed to
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
